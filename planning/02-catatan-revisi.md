...
| 2026-06-07 | Eksekusi | Fase 2 | Risiko Data | Tinggi | Open | Kelas `neutral` hanya ~7.5% (hanya dari SmSA; PRDECT-ID tak punya neutral). Imbalance spread 47.3% (> ambang 15%). | Wajib `class_weight` di Fase 4; tambah Kaggle (rating=3→neutral); pertimbangkan augmentasi. |
